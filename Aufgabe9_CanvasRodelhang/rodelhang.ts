...
//------------- Schleifen
    ...
    // 3 Wolken an zufälliger Position
        for (let i: number = 0; i < 3; i++) {
            let x: number = 100 + Math.random() * 120;
     ...
     // 2 Bäume in einer Reihe
      ...
      // 100 Schneeflocken an zufälliger Position
        for (let i: number = 0; i < 100; i++) {
            let x: number = 10 + Math.random() * 400;
            let y: number = 5 + Math.random() * 480;
...
// Function drawKid1
        function drawKid1(x: number, y: number, color: string): void {
...
// Function drawKid2
        function drawKid2(x: number, y: number, color: string): void {
...
// Function drawKid3
        function drawKid3(x: number, y: number, color: string): void {
...
// Function drawKid4
        function drawKid4(x: number, y: number, color: string): void {
