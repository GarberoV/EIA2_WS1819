...
(function (a2) {
    ...
    function uno() {
        ...
        // ############################################################
        function createCard(_cardName, _imageUrl, _x) {
            let card = document.createElement("img");
            card.src = _imageUrl;
            for (let i = 0; i < x; i++) {
                let randomNumber = randomCards(allCards.length);
                displayHand(allCards[randomNumber].cardName, allCards[randomNumber].imageUrl, i);
                let c = allCards.splice(randomNumber, 1)[0];
                handCards.push(c);
                continue;
            }
        }
        function displayHand(_cardName, _imageUrl, _x) {
        ...
        function deleteCards() {
            let node = document.getElementById("desk");
            node.innerHTML = "";
        }
    }
})(a2 || (a2 = {}));
