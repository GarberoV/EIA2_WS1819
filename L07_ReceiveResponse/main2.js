...
(function (a7) {
    ...
    let zusatz;
    let label;
    let basketBaumart = [a7.sort[0][0], "" + a7.sort[0][1]];
    let basketHalter = ["bitte Halter auswählen", "0"];
    let basketBeleuchtung = [a7.light[0][0], "" + a7.light[0][1]];
    let basketSchmuck = [];
    ...
    function createElements() {
        ...
        for (let i = 0; i < a7.artikel.length; i++) {
            if (a7.artikel[i].art == "Sorte") {
                let choice = document.createElement("option");
                choice.innerText = a7.artikel[i].bezeichnung;
                choice.id = "option" + i;
        ...
        for (let i = 0; i < a7.artikel.length; i++) {
            if (a7.artikel[i].art == "Halter") {
                ...
                label.innerText = a7.artikel[i].bezeichnung;
        ...
        for (let i = 0; i < a7.artikel.length; i++) {
            if (a7.artikel[i].art == "Beleuchtung") {
                ...
                label4.innerText = a7.artikel[i].bezeichnung;
        ...
        for (let i = 0; i < a7.artikel.length; i++) {
            if (a7.artikel[i].art == "Schmuck") {
                ...
                label2.innerText = a7.artikel[i].bezeichnung;
        ...
        for (let i = 0; i < a7.artikel.length; i++) {
            if (a7.artikel[i].art == "Lieferung") {
                ...
                label3.innerText = a7.artikel[i].bezeichnung + ", " + a7.artikel[i].preis + "\u20ac";
    ...
    function warenkorb(_event) {
        ...
        for (let i = 0; i < a7.artikel.length; i++) {
            ...
            if (target.value == a7.artikel[i].bezeichnung && target.id == "selectBaumart") {
                basketBaumart[0] = a7.artikel[i].bezeichnung;
                basketBaumart[1] = "" + a7.artikel[i].preis;
            }
            if (target.id == "radio2." + i) {
                basketHalter[0] = a7.artikel[i].bezeichnung;
                basketHalter[1] = "" + a7.artikel[i].preis;
            }
            if (target.id == "radio3." + i) {
                basketLieferung[0] = a7.artikel[i].bezeichnung;
                basketLieferung[1] = "" + a7.artikel[i].preis;
            }
            if (a7.artikel[i].art == "Beleuchtung") {
                stepper[i] = document.getElementById("stepper" + i);
                checkBoxes[i] = document.getElementById("check" + i);
            ...
            if (target.id == "check" + i || target.id == "stepper" + i) {
                basketSchmuck[i] = [a7.artikel[i].bezeichnung, "" + (a7.artikel[i].preis * parseInt(stepper[i].value))];
            }
        }
    ...
    function init(_event) {
        // setupAsyncForm();
        let bestellButton = document.getElementById("submit");
