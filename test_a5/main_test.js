...
(function (test) {
    ...
    let zusatz;
    let label;
    let basketBaumart = [test.sort[0][0], "" + test.sort[0][1]];
    let basketHalter = ["bitte Halter auswählen", "0"];
    let basketBeleuchtung = [test.light[0][0], "" + test.light[0][1]];
    let basketSchmuck = [];
    ...
    function createElements() {
        ...
        for (let i = 0; i < test.artikel.length; i++) {
            if (test.artikel[i].art == "Sorte") {
                let choice = document.createElement("option");
                choice.innerText = test.artikel[i].bezeichnung;
                choice.id = "option" + i;
        ...
        for (let i = 0; i < test.artikel.length; i++) {
            if (test.artikel[i].art == "Halter") {
                ...
                label.innerText = test.artikel[i].bezeichnung;
        ...
        for (let i = 0; i < test.artikel.length; i++) {
            if (test.artikel[i].art == "Beleuchtung") {
                ...
                label4.innerText = test.artikel[i].bezeichnung;
        ...
        for (let i = 0; i < test.artikel.length; i++) {
            if (test.artikel[i].art == "Schmuck") {
                ...
                label2.innerText = test.artikel[i].bezeichnung;
        ...
        for (let i = 0; i < test.artikel.length; i++) {
            if (test.artikel[i].art == "Lieferung") {
                ...
                label3.innerText = test.artikel[i].bezeichnung + ", " + test.artikel[i].preis + "\u20ac";
    ...
    function warenkorb(_event) {
        ...
        for (let i = 0; i < test.artikel.length; i++) {
            ...
            if (target.value == test.artikel[i].bezeichnung && target.id == "selectBaumart") {
                basketBaumart[0] = test.artikel[i].bezeichnung;
                basketBaumart[1] = "" + test.artikel[i].preis;
            }
            if (target.id == "radio2." + i) {
                basketHalter[0] = test.artikel[i].bezeichnung;
                basketHalter[1] = "" + test.artikel[i].preis;
            }
            if (target.id == "radio3." + i) {
                basketLieferung[0] = test.artikel[i].bezeichnung;
                basketLieferung[1] = "" + test.artikel[i].preis;
            }
            if (test.artikel[i].art == "Beleuchtung") {
                stepper[i] = document.getElementById("stepper" + i);
                checkBoxes[i] = document.getElementById("check" + i);
            ...
            if (target.id == "check" + i || target.id == "stepper" + i) {
                basketSchmuck[i] = [test.artikel[i].bezeichnung, "" + (test.artikel[i].preis * parseInt(stepper[i].value))];
            }
        }
